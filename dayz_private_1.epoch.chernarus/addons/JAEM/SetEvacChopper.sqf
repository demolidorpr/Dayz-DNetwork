...
//If not exit script
_hasBriefcase = ("ItemBriefcase100oz" in _magazinesPlayer);
...
if (!_hasBriefcase) then {
	...
	[player, "ItemBriefcase100oz", 1] call BIS_fnc_invRemove;
	systemChat("Making a Evac-Chopper costs 1 Full Briefcase - Thanks for your payment!");
};
