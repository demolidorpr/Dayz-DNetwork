...
_maintainSand = ["ModularItems","DZE_Housebase","LightPole_DZ","Sandbag1_DZ","BagFenceRound_DZ","Fort_RazorWire","Hedgehog_DZ"];

//_objectClasses = ["ModularItems", "DZE_Housebase"] + DZE_ExtraMaintain;

_objectClasses = _maintainSand;
_range = 40; // set the max range for the maintain area
...
_requirements = [];
switch true do {
	case (_count <= 20): {_requirements = [["ItemGoldBar10oz",1]]};
	case (_count <= 50): {_requirements = [["ItemGoldBar10oz",2]]};
	case (_count <= 100): {_requirements = [["ItemGoldBar10oz",5]]};
	case (_count <= 200): {_requirements = [["ItemBriefcase100oz",1]]};
	case (_count <= 300): {_requirements = [["ItemBriefcase100oz",2]]};
	case (_count <= 400): {_requirements = [["ItemBriefcase100oz",3]]};
	case (_count <= 500): {_requirements = [["ItemBriefcase100oz",4]]};
	case (_count <= 600): {_requirements = [["ItemBriefcase100oz",5]]};
	case (_count > 700): {_requirements = [["ItemBriefcase100oz",6]]};
};
